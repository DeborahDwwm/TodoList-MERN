...
import HabitsTracker from "../components/HabitsTrackers/HabitsTrackers";
...
function Home() {
    ...
    const renderHabits = () => {
      switch(activeTab) {
          case 'todo':
              return <HabitsTracker userId={user._id} filter="todo" />;
          case 'completed':
              return <HabitsTracker userId={user._id} filter="completed" />;
          case 'all':
              return <HabitsTracker userId={user._id} filter="all" />;
          default:
              return null;
      }
  };
          ...
          <div className="homeBody">
            <div className="homePage">
              <div className="homeLogo">
                  <img className='logoTodo' src="simple logo todo.png" alt="Logo"/>
                  <p>ToDo List & <strong>Growth</strong></p>
              </div>
              <a href="/login">
